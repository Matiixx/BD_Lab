...
public class Metadane {
  public static void main(String[] argv) {
    ...
    Connection c = null;
    try {
      String dbaseURL = "jdbc:postgresql://localhost/u0cichostepski";
      String username = "u0cichostepski";
      String password = "0cichostepski";
    ...
    if (c != null) {
      ...
      try {
        ...
        ResultSet rs = st.executeQuery("SELECT fname,lname FROM lab11prep.osoba");
        while (rs.next()) {
